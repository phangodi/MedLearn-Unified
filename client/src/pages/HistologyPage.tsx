...
export function HistologyPage() {
  ...
  const mtos = [
    ...
    { id: 'mto2', name: 'MTO2', title: 'Nervous System and Sense Organs', description: 'Slides 1-9 (9 Slides)', enabled: true, image: '/subjects/histo_mto2.png', path: '/histology/mto2' },
  ]
